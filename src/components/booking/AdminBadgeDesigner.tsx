...
export default function AdminBadgeDesigner({ onClose, onSaved }: AdminBadgeDesignerProps) {
  ...
  return (
    <div className="w-full bg-white dark:bg-[#0C121C] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 text-slate-900 dark:text-slate-100 shadow-sm dark:shadow-2xl space-y-6 select-none font-sans">
      {/* Toast */}
      {toastMsg && (
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-sky-500/20 text-sky-600 dark:text-sky-400 text-[10px] font-bold tracking-wider uppercase">
              Admin Studio
            </span>
            <h3 className="font-bold text-lg text-slate-900 dark:text-white">ID Card Drag & Drop Layout Studio</h3>
          </div>
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
            Drag any item on the badge, or use <strong className="text-emerald-600 dark:text-emerald-400">Arrow Keys (↑ ↓ ← →)</strong> for exact 1px precision movement.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-semibold text-xs flex items-center gap-1.5 shadow-md transition-colors"
          >
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-xs flex items-center gap-1.5 shadow-md transition-colors"
          >
      ...
      {/* Role Switcher */}
      <div className="flex items-center gap-3 p-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 w-fit">
        <button
          onClick={() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-5 bg-slate-50 dark:bg-slate-900/70 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 text-xs">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={handleAddCustomText}
                className="text-[10px] text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 font-semibold flex items-center gap-1"
              >
                ...
                return (
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-left flex items-center gap-2 transition-all ${
                      isSelected
                        ? "bg-sky-500/20 border-sky-500 text-sky-700 dark:text-sky-300 font-semibold shadow-xs"
                        : "bg-white dark:bg-slate-800/60 border-slate-200 dark:border-slate-700/60 text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200"
                    }`}
                  >
          ...
          <div className="p-4 rounded-xl bg-white dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-4 shadow-xs">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800">
              <span className="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[11px] flex items-center gap-1.5">
                <Move className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" />
              ...
              <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-900 p-1 rounded-lg border border-slate-200 dark:border-slate-800">
                <span className="text-[9px] text-slate-500 dark:text-slate-400 font-mono px-1">1px Nudge:</span>
                <button
                  onClick={() => nudgeSelectedElement(0, -1)}
                  title="Move Up 1px (ArrowUp)"
                  className="p-1 rounded bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700"
                >
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <div className="flex justify-between text-[11px] text-slate-400 mb-1">
                      ...
                      <span className="font-mono text-slate-200">{currentConfig.qrPlacement.x}%</span>
                    </div>
                    <input
                      type="range"
                      min="10"
                  ...
                  <div>
                    <div className="flex justify-between text-[11px] text-slate-400 mb-1">
                      ...
                      <span className="font-mono text-slate-200">{currentConfig.qrPlacement.y}%</span>
                    </div>
                    <input
                      type="range"
                      min="15"
                ...
                <div>
                  <div className="flex justify-between text-[11px] text-slate-400 mb-1">
                    ...
                    <span className="font-mono text-slate-200">{currentConfig.qrPlacement.size}px</span>
                  </div>
                  <input
                    type="range"
                    min="64"
