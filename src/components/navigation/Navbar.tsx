  ...
  return (
    <>
      ...
      <nav className="relative w-full z-40 bg-[var(--c-bg)] border-b border-black/[0.08] transition-colors duration-200">
        <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-10 h-[88px] sm:h-[98px] grid grid-cols-[auto_1fr_auto] gap-4 items-center">
          ...
          <div className="flex items-center justify-start shrink-0">
            ...
            >
              <Image
                ...
                height={95}
                priority
                className="h-16 sm:h-20 lg:h-22 w-auto object-contain transition-transform duration-200"
              />
            </Link>
          </div>
      ...
      <div
        ...
        className={`lg:hidden fixed top-[88px] sm:top-[98px] left-0 right-0 bottom-0 z-40 bg-white border-t border-black/[0.06] overflow-y-auto transition-transform duration-300 ease-out ${mobileOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
        style={{ display: mobileOpen ? 'block' : undefined }}
      >
        <div className="px-6 py-6 flex flex-col gap-1 min-h-[calc(100vh-88px)] sm:min-h-[calc(100vh-98px)] justify-between">
