    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 flex flex-col">
      ...
      <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 flex-grow">
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          {/* Section 2.5: Student Clean Energy Innovation Competition & Youth Challenge */}
          <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-xs space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1 max-w-2xl">
                  Inspiring the next generation of engineers and visionary scientists across universities in Nepal and South Asia to develop viable solutions in hydropower, solar, battery storage, and green hydrogen.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <a
                href="/files/competition.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="p-4 rounded-xl bg-[#F8FAFB] hover:bg-white border border-slate-200 hover:border-[#10B981] hover:shadow-md transition-all flex flex-col justify-between group"
              >
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-slate-400 group-hover:text-[#087EA4]">PDF ↗</span>
                  </div>
                  <h4 className="font-bold text-sm text-slate-900 group-hover:text-[#087EA4] transition-colors">
              ...
              <a
                href="/files/challenge.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="p-4 rounded-xl bg-[#F8FAFB] hover:bg-white border border-slate-200 hover:border-[#087EA4] hover:shadow-md transition-all flex flex-col justify-between group"
              >
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold text-[#087EA4] bg-sky-50 px-2 py-0.5 rounded border border-sky-200">
                      TECHNICAL CHALLENGE
                    </span>
                    <span className="text-xs text-slate-400 group-hover:text-[#087EA4]">PDF ↗</span>
                  </div>
                  <h4 className="font-bold text-sm text-slate-900 group-hover:text-[#087EA4] transition-colors">
                    Hydro Innovation Challenge
                  </h4>
                  <p className="text-xs text-slate-500 font-normal line-clamp-2">
                    Problem statements focusing on silt abrasion monitoring, IoT runner sensing, and hybrid grid stability.
                  </p>
                </div>
                <div className="pt-3 text-[11px] font-mono font-bold text-[#087EA4] flex items-center gap-1">
                  <span>Download Challenge Brief</span>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-4 rounded-xl bg-[#F8FAFB] hover:bg-white border border-slate-200 hover:border-[#061A2A] hover:shadow-md transition-all flex flex-col justify-between group"
              >
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                  ...
                  <p className="text-xs text-slate-500 font-normal line-clamp-2">
                    Official submission form for university academic departments, teams, and faculty supervisors.
                  </p>
                </div>
                <div className="pt-3 text-[11px] font-mono font-bold text-[#087EA4] flex items-center gap-1">
